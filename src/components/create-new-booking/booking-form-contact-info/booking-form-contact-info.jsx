...
const BookingFormContactInfo = ({clientName, setClientName,
    ...
    useEffect(() => {
        ...
        if (currentUser !== undefined && currentUserDataLoaded === false && clientName === undefined &&  currentUser !== null){
                ...
                <div>
                    ...
                    <IonGrid>
                        <IonRow >
                            ...
                            <IonCol pull={2}>
                                <IonButton disabled={!formCompleted}  onClick={() => onSaveAndContinueClick()} fill="solid" color="secondary" >Save & Continue</IonButton>
...
export default BookingFormContactInfo;